...
def site_visit_request(request):
    ...
    if request.method == 'POST':
        ...
        if user_wallet.balance < 1000:
            messages.warning(request, 'You need at least Rs 1000 in your wallet balance to submit a site visit request.')
            return redirect('core:index')  # Adjust the redirect URL as needed
